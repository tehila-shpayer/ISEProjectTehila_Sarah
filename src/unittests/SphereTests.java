...
public class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        assertNull("Ray starts after the sphere",
                sphere.findIntersections(new Ray(new Point3D (0.5, 0.0, -1.7320508075688774) , new Vector(0, 0, -sqrt3/2))));
        ...
        assertNull("Ray starts at sphere and goes outside",
                sphere.findIntersections(new Ray(new Point3D(2, 0, 0), new Vector(1.5, -0.5, -1/sqrt2))));
